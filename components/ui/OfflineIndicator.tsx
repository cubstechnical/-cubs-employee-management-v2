      ...
      <Card className={`border-l-4 ${
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className={`flex-shrink-0 ${
            isOnline ? 'text-blue-600 dark:text-blue-400' : 'text-orange-600 dark:text-orange-400'
          }`}>
            {isOnline ? (
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between">
              <p className={`text-sm font-medium ${
                isOnline ? 'text-blue-800 dark:text-blue-200' : 'text-orange-800 dark:text-orange-200'
              }`}>
            ...
            <p className={`text-xs mt-1 ${
              isOnline ? 'text-blue-700 dark:text-blue-300' : 'text-orange-700 dark:text-orange-300'
            }`}>
              {isOnline
