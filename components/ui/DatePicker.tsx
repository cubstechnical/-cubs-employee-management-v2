...
// Dynamically import the heavy react-datepicker library
const DatePickerLib = lazy(() => import('react-datepicker'));
        ...
        <Suspense fallback={
          <div className={cn(
            ...
            error
              ...
              : '',
            'pl-4 pr-4 py-2.5 flex items-center',
            className
          )}>
            <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-[#d3194f] mr-2"></div>
            Loading date picker...
          </div>
        }>
          <DatePickerLib
