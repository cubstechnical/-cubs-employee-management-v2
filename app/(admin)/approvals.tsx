...
export default function AdminApprovals() {
  ...
  const handleApproveUser = async (userId: string) => {
    ...
    try {
      ...
      if (error) {
        ...
        // Force immediate refresh from database (without loading spinner)
  ...
  // Strict access control - only info@cubstechnical.com can access approvals
  if (!user || user.role !== 'admin' || user.email !== 'info@cubstechnical.com') {
    return (
      <Layout>
