...
export default function LoginPageWithBgImage() {
  ...
  return (
    <div className={`min-h-screen flex items-center justify-center login-background-image p-4 relative ${
      backgroundLoaded ? 'loaded' : 'loading'
    }`}>
      <div className="w-full max-w-md">
        {/* Logo */}
        <div className="login-logo-container-image">
        ...
        <Card className="p-8 login-card-image">
          {!isForgotPassword ? (
            <>
